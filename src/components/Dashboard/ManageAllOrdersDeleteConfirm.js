...
const ManageAllOrdersDeleteConfirm = ({ removeOrders, setRemoveOrders, refetch }) => {
    const { _id } = removeOrders;
    const handleDelete = id => {
        fetch(`https://gentle-ocean-30847.herokuapp.com/order/${id}`, {
            method: "DELETE",
            headers: {
...
export default ManageAllOrdersDeleteConfirm;